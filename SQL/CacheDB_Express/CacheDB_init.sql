...
GO
ALTER DATABASE [CacheDB] SET COMPATIBILITY_LEVEL = 110
GO
...
GO
ALTER DATABASE [CacheDB] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [CacheDB] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
USE [CacheDB]
GO
